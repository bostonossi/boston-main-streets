...
my_api_key = 'AIzaSyAujGuNNkZVxr2VM59moiQ2ulQUclKpCr0'       #API key for getting longitude and latitude for an address
                                                             #5$ per 1,000 request
...
result_last = '&username=j_vugar'                                         #longitude and latitude pair
intersection_name = []
intersection_long = []
intersection_lat = []
