...
def address_longitude(df):
    ...
    my_api_key = 'AIzaSyBiPsw1IxN6hs3aa1HJmxRBsFPUpqjnyfI'     				#your Google API key for geocode here  
...
def find_intersection(df):
    ...
    result_last = '&username=j_vugar'                                          #your geoname username here
...
def get_businesses(df, corner_dict): 
    ...
    client_id = 'XZkOLGUfLSz-R3eN6OMvjw'  #your client ID for yelp here
    api_key_yelp = 'MCNN5njd6ZZ5tCRU8SFZLQYn9pJGzbKVVm3y3LBo6sMKknZETj4riFY7A5NVoJ2XrmNdzubXeDyWV0qagNEQM20Kz62rcJ-4N8sctRkOsolEKLWacuoXQI8HrnLDXHYx'  #your yelp API key here
    headers = {
